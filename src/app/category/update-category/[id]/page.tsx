...
import React, { Usable, use, useCallback, useEffect, useState } from 'react'
...
export default function Page({ params, searchParams }: { params: any, searchParams: any }) {
    ...
    const { data, isLoading } = useSWR('/gettingAllCategoriesFOrAdmin', () => get_category_by_id(page_params.id))
                ...
                isLoading || loader ? (
                    <div className='w-full  flex-col h-96 flex items-center justify-center '>
                        <TailSpin
                            ...
                            visible={true}
                        />
                        <p className='text-sm mt-2 font-semibold text-gray-900'>updating Category Hold Tight ....</p>
                    </div>
                ) : (
